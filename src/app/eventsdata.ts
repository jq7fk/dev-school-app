...
export var events = [
    new Event(1, "Tacos after work", "Tako Nako", "June 10, 2019", "12:30 PM", users[4], [users[0], users[1], users[4]], [], "https://hips.hearstapps.com/del.h-cdn.co/assets/18/11/1520956952-chicken-tacos-horizontal.jpg", "This will be super fun!"),
